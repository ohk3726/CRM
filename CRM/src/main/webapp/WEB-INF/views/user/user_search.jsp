...
<body>
	<div style="width:100%;text-align:right;">
		...
		<form method="post" action="user_search" id="search_1">
			...
			<input type="text" name="keyword" value="${keyword}" onkeypress="if(event.keyCode==13){javascript:search_1();}">
	...
	<script>
		$("#user_search > option[value=${search_select}]").attr("selected",true);
	</script>
	<script>
		$("#job > option[value=${user_job}]").attr("selected",true);
	</script>
	<script>
		$("#order > option[value=${user_order}]").attr("selected",true);
	</script>
</body>
</html>